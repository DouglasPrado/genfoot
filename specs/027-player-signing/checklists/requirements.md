# Checklist de requisitos — GP-008

**Feature**: [Contratação de jogador](../spec.md)  
...
- [x] Escritas permanecem com C6 possui scouting/negociação/contrato; C4 exame; C7 inscrição; C9 reserva/liquidação; X-002 orquestra SAGA-01; X-003 apresenta.
- [x] A evidência atual é delimitada como: nenhuma fatia executável da contratação está entregue.
