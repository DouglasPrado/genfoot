...
| Status reconciliation      | PASS — 1 DELIVERED, 10 PARTIAL, 23 PLANNED                           |
...
| BC-007  | `specs/007-competitions-calendar`           | PARTIAL   | 7/7       | PASS      | 0       |
| BC-008  | `specs/008-match-runtime`                   | PLANNED   | 7/7       | PASS      | 0       |
| BC-009  | `specs/009-economy-ledger`                  | PLANNED   | 7/7       | PASS      | 0       |
...
| BC-001  | `specs/014-identity-club-control`           | PLANNED   | 7/7       | PASS      | 0       |
| BC-010  | `specs/015-supporters-narrative`            | PLANNED   | 7/7       | PASS      | 0       |
| BC-011  | `specs/016-notifications-history`           | PLANNED   | 7/7       | PASS      | 0       |
| BC-012  | `specs/017-anti-abuse-admin`                | PLANNED   | 7/7       | PASS      | 0       |
