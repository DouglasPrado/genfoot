# Checklist de requisitos — GP-005

**Feature**: [Ciclo semanal de gestão](../spec.md)  
...
- [x] Escritas permanecem com C2 coordena tempo; C3…C11 escrevem somente seus aggregates; X-001 usa commands normais; X-003 apresenta read models.
- [x] A evidência atual é delimitada como: avanço diário e lifecycle básico existem; Central e integrações de gestão/partida ainda faltam.
