# Implementation Plan: Ciclo semanal de gestão
...
Entregar fechar o loop central semanal do gestor, das urgências e preparação até partida e consequências, com delegação explícita. A integração usa contracts oficiais e projeção de jornada; cada escrita permanece com seu bounded context.

## Technical Context

**Language/Runtime**: TypeScript 5.7, Node.js 22, ESM.  
**Dependencies**: casos de uso e contratos de BC-002, BC-003, BC-004, BC-005, BC-006, BC-007, BC-008, BC-009, BC-010, BC-011, X-001 e X-003; Vitest; eventing/saga quando aplicável.  
...
**Scale**: uma instância correlaciona BC-002, BC-003, BC-004, BC-005, BC-006, BC-007, BC-008, BC-009, BC-010, BC-011, X-001 e X-003; múltiplas instâncias/mundos podem avançar concorrentemente.  
**Current vs target**: avanço diário e lifecycle básico existem; Central e integrações de gestão/partida ainda faltam; alvo é uma semana completa processa cada decisão e consequência uma vez, mantém deadlines e explica ações delegadas sem escrita pelo cliente.
...
```text
specs/024-weekly-management-cycle/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
...
**Structure decision**: não criar módulo de domínio `weekly-management-cycle`; compor portas públicas dos owners e uma projeção E2E.
...
- [contracts/README.md](contracts/README.md): intents roteadas aos owners: `UpdateTrainingPlan`, `RespondTransferOffer`, `SetMatchLineup`, `SetMatchTacticalPlan`, `ConfigureAutomationRule`; `GetManagementCentral`, `ListUrgentDecisions`, `GetSquadCondition`, `GetNextMatchPreparation`, `GetPostMatchSummary`; eventos oficiais de C3…C11 projetados em `ManagementCentralUpdated`.
...
1. Congelar envelopes e erros dos owners em BC-002, BC-003, BC-004, BC-005, BC-006, BC-007, BC-008, BC-009, BC-010, BC-011, X-001 e X-003.
