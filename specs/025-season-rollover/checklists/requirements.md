# Checklist de requisitos — GP-006

**Feature**: [Encerramento e virada de temporada](../spec.md)  
...
- [x] Escritas permanecem com C2 orquestra SAGA-02; C4/C6/C7/C9/C11 escrevem seus estados; C8 fornece resultados; X-002 entrega/checkpointa.
- [x] A evidência atual é delimitada como: `SeasonDue`, scheduler, lease/fencing/retry e checkpoints básicos existem; SAGA-02 completa e domínios consumidores faltam.
