...
| ------------------------------ | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `UpdateClubIdentity`           | `name`, `shortCode`                                                                       | Closes the previous identity period and opens one active period. `name` must be unique in the world. Same logical day as the open period: last write wins — the open period is replaced (closed periods are never rewritten); earlier dates are rejected. |
