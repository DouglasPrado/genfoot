# Checklist de requisitos — GP-004

**Feature**: [Início de temporada](../spec.md)  
...
- [x] Escritas permanecem com C2 orquestra temporada/janelas; C3 possui objetivos e elenco; C7 publica competição/inscrição; C9 possui orçamento; C11 comunica.
- [x] A evidência atual é delimitada como: `SeasonStarted` e temporada linear existem; publicação completa, janelas, objetivos, orçamento e pré-temporada faltam.
