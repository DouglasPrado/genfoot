# Checklist de requisitos — GP-007

**Feature**: [Preparação e partida](../spec.md)  
...
- [x] Escritas permanecem com C8 possui runtime/resultado; C4 possui saúde/desenvolvimento; C5 staff; C7 elegibilidade/homologação; concerns só decidem, transportam e apresentam.
- [x] A evidência atual é delimitada como: nenhuma implementação do runtime autoritativo está entregue.
