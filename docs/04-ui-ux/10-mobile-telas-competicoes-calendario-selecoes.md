...
> **Status:** Rascunho consolidado · **Fontes:** docs/01-game-design/06-temporada-e-competicoes.md, docs/01-game-design/12-selecoes-e-calendario-internacional.md, docs/01-game-design/13-relatorios-notificacoes-e-memoria.md, docs/01-game-design/01-mundo-persistente-e-clubes.md · **Revisão:** 2026-07-11
...
- **Referências:** [`06-temporada §15.2`](../01-game-design/06-temporada-e-competicoes.md). > **Pendência:** limites numéricos (estrangeiros, cota de formados) em aberto.
...
- **Estados:** cerimônias/hall da fama como evento são [pendência da fonte](../01-game-design/13-relatorios-notificacoes-e-memoria.md); o acervo de dados existe.
