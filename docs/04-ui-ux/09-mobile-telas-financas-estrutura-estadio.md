...
- **Componentes e dados:** **objetivos** (esportivos/financeiros) e avaliação; **pressão da diretoria**; **perfil da diretoria** (Conservadora/Negociadora/Ousada/Formadora/Financeira/Ambiciosa); **teto/alcance de contratação** por nível; **estados de intervenção** ([doc 01, §1.3](../01-game-design/01-mundo-persistente-e-clubes.md)): aprovação obrigatória de gastos, limites de orçamento baixados, bloqueio de novas obrigações, exigência de vendas, metas corretivas, **plano de recuperação** — nunca demissão (autonomia, não permanência).
...
- **Referências:** [`04-estrutura §3.1, §5, §10`](../01-game-design/04-estrutura-do-clube-e-staff.md); [`01-mundo §1.3`](../01-game-design/01-mundo-persistente-e-clubes.md).
