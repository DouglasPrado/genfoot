...
| 14 | [Wireframes — Telas densas (mobile)](14-wireframes-telas-densas.md) | Wireframes **textuais** (ASCII/blocos) das 6 telas mais densas (`M-HOME`, `M-LIVE`, `M-SEASON-CLOSE`, `M-STRUCTURE`, `M-SQUAD`, `M-NEGOTIATION`): arranjo espacial e fluxo de leitura em tela pequena, complementando as specs (03–13) e o design system (00 §4.2). |
