...
> **Recomendação (a ratificar — R-32):** **não** criar um comando explícito e repetível de "fazer cera". A gestão de tempo **emerge** da postura de fim de jogo "segurar o resultado" (esta seção) e do timing das substituições; caso um gatilho pontual de "ganhar tempo" seja adicionado, ele carrega risco real embutido (cartão por retardamento, irritação do adversário, pressão da arbitragem) e perde efeito com o uso repetido. Racional: um botão dedicado de cera viraria tática dominante e contradiz a filosofia de resultado emergente e o anti-exploit da [seção 12](#12-sistema-online-vs-offline).
