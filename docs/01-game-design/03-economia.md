...
> - **Força total do elenco inicial:** teto comum de **1.500 pontos** repartidos entre setores (GK/defesa/meio/ataque), **23 jogadores** → média ≈ **65 de overall** por jogador. Elenco propositalmente **envelhecido**: predomínio **26–33 anos**, com ≈70% em 29–33 e ≈30% em 26–28, potencial baixo (teto de evolução ≤ +3) e contratos curtos (1–2 temporadas) — é o déficit de pirâmide que o balanceador corrige ([14.5](#145-geração-baseada-em-aposentadoria-e-pirâmide-etária), R-44).
