...
- [01 · Navegação e Arquitetura de Informação](04-ui-ux/01-navegacao-e-arquitetura-de-informacao.md) — tab bar, stacks, deep links e o **sitemap completo** (97 telas mobile + 15 admin).
