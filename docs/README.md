...
> **Status:** CANÔNICO · **Revisão:** 2026-07-13
...
Esta documentação foi consolidada a partir das conversas de brainstorming em [`../chats/`](../chats/), preservadas como fonte histórica. A baseline normativa foi ratificada em 2026-07-13; qualquer nova lacuna deve ser registrada no backlog ou em ADR, sem ser preenchida implicitamente.
...
- [`AUDITORIA-PRONTIDAO-2.md`](AUDITORIA-PRONTIDAO-2.md) — fotografia histórica da reauditoria de 2026-07-12, com adendo final de encerramento.
- [`BACKLOG-PENDENCIAS.md`](BACKLOG-PENDENCIAS.md) — registro de fechamento documental e gates verificáveis da implementação; não é uma lista de decisões abertas.
- [Baseline ratificada](99-decisoes/baseline-ratificada-2026-07-13.md) e [fechamentos complementares](99-decisoes/fechamentos-complementares-2026-07-13.md) — atos que encerram as decisões remanescentes.

### Portfólio executável

- [Roadmap mestre Spec Kit](../specs/001-game-delivery-roadmap/spec.md) — escopo, histórias e critérios de sucesso do programa completo.
- [Índice canônico de features](../specs/001-game-delivery-roadmap/contracts/feature-catalog.md) — 34 entregas com status, dependências, saídas e fontes.
- [Índice navegável dos pacotes](../specs/README.md) — acesso aos specs filhos de contexts, concerns, golden paths, validação e operações.
...
- [02 · Modelo de Dados](02-tecnico/02-modelo-de-dados.md) — modelo conceitual canônico; a baseline Prisma pré-migration e o catálogo DB-01..DB-16 definem a materialização.
...
- [11 · Dicionário Canônico](02-tecnico/11-dicionario-canonico.md)
- [12 · Context Map e Blueprint](02-tecnico/12-context-map-e-blueprint.md)
- [13 · Ledger e Conservação Econômica](02-tecnico/13-ledger-e-conservacao-economica.md)
- [14 · Máquinas de Estado](02-tecnico/14-maquinas-de-estado.md)
- [15 · Ruleset e Replay](02-tecnico/15-ruleset-e-replay.md)
- [16 · Sagas e Workflows](02-tecnico/16-sagas-e-workflows.md)
- [17 · Critérios de Aceite e Bandas](02-tecnico/17-criterios-de-aceite-e-bandas.md)
- [18 · Capacidade e Custo](02-tecnico/18-capacidade-e-custo.md)
- [19 · Segurança, DR e HA](02-tecnico/19-seguranca-dr-ha.md)
- [20 · Modelo Físico, Constraints e Ownership](02-tecnico/20-modelo-fisico-constraints-e-ownership.md)
...
- **Contratos e cobertura:** [14 · Wireframes densos](04-ui-ux/14-wireframes-telas-densas.md) · [23 · Rastreabilidade UX/API](04-ui-ux/23-rastreabilidade-ux-api.md) · [24 · Layouts canônicos e cobertura](04-ui-ux/24-layouts-canonicos-e-cobertura.md), com as 138 telas mapeadas.
...
- [Reescrita do core R-175..R-182](99-decisoes/reescrita-do-core-2026-07-16.md)
...
- **Pendências:** não há decisão documental conhecida em aberto nesta baseline. Novas lacunas devem receber ID, owner, prazo e critério de encerramento no backlog ou em ADR.
...
- **Decisões da consolidação:** `R-01..R-170` estão ratificadas, exceto os IDs deliberadamente reservados `R-35..R-40` e `R-108`. A autoridade e as exceções estão nos dois atos de 2026-07-13; valores sujeitos a tuning continuam versionados, mas não são decisões ausentes.
