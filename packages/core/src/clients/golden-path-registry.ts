...
export const GOLDEN_PATH_REGISTRY: readonly GoldenPathDefinition[] = [
  ...
  path({ id: "GP-005", title: "Ciclo semanal de gestão", summary: "Revise urgências, elenco, treino, mercado e próxima partida.", screenIds: ["M-HOME", "M-SQUAD", "M-TRAINING", "M-NEXTMATCH"], queryTypes: ["world", "players", "inbox", "matches"], commandTypes: ["player:set-training", "world:advance-day"], offlineIntentTypes: ["SET_LINEUP_DRAFT", "TOGGLE_TRAINING_FOCUS"], risk: "medium" }),
  ...
  path({ id: "GP-011", title: "Jornada de um jovem", summary: "Capte, desenvolva e promova talentos com histórico preservado.", screenIds: ["M-ACADEMY", "M-YOUTH-PLAYER", "M-CAREER-PLAN", "M-PROMOTE"], queryTypes: ["players", "club"], commandTypes: ["player:generate-youth", "player:set-training", "player:promote-youth"], offlineIntentTypes: ["TOGGLE_TRAINING_FOCUS"], risk: "high" }),
